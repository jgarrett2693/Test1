...
# Source reference: https://drive.google.com/file/d/1aBmxIrM-nWrOMB30irepuP63I5uNw_6Z/view?usp=drivesdk
...
def generate_overlay() -> BytesIO:
    ...
    # Bill To name area (cover "JOSHUA GARRETT" lines).
    cover_rect(28.0, 553.0, 200.0, 580.0)   # two name lines in Bill To
    # Ship To name area (cover "GARRETT, JOSHUA" line).
    cover_rect(215.0, 569.0, 370.0, 580.0)  # first name line in Ship To

    # Reset fill color for text.
    c.setFillColorRGB(0, 0, 0)

    # New customer name (replacing JOSHUA GARRETT with JAMES M.).
    c.setFont("Helvetica-Bold", 9)
    c.drawString(30.0, 572.0, "JAMES M.")   # Bill To line 1
    c.drawString(30.0, 562.0, "JAMES M.")   # Bill To line 2
    c.drawString(217.0, 572.0, "M., JAMES") # Ship To line 1
